...
1. get_vwap (for the ticker) — note whether price is above or below VWAP and by how much.
1. get_expected_move (for the ticker) — note how much of the daily range is already used. If >70% used, flag as “late entry” and reduce confidence by at least 2 points.
1. get_options_chain — get the chain with Greeks. Target delta 0.30–0.50 only. Reject strikes outside this range.
