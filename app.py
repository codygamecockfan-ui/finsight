...
DB_PATH = os.path.join(os.path.dirname(**file**), “finsight_trades.db”)
...
1. **Trade Thesis** – Why this trade makes sense RIGHT NOW
1. **Option Contract** – Strike price and expiration date
1. **Entry Price** – The premium range to buy the contract at
1. **Target Price (Exit)** – The premium or underlying price at which to take profit
1. **Stop Loss** – The point at which to cut the trade
1. **Delta & IV Context** – Note whether IV is elevated and approximate delta
1. **Risk Level** – Low / Medium / High / Speculative
1. **Confidence Level** – Your conviction 1–10 with brief justification
1. **Time Sensitivity** – When to enter
...
1. **Entry Zone** – Price range to accumulate
1. **Price Targets** – Short-term and medium-term targets
1. **Stop Loss** – Clear invalidation level
1. **Catalysts** – Upcoming events that could drive the move
1. **Risk/Reward Ratio** – Always calculate and present this
